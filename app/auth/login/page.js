...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col items-center justify-center px-4 py-10 overflow-hidden font-sans">
      ...
      {/* Glass Card */}
      <div className="w-full max-w-[420px] bg-white/70 backdrop-blur-2xl border border-violet-200/50 rounded-3xl px-8 py-8 shadow-[0_8px_48px_rgba(109,93,230,0.10)] animate-[fadeUp_0.6s_ease_both] [animation-delay:0.1s]">
        ...
        <h1 className="text-[22px] font-bold text-indigo-950 mb-1">Welcome Back</h1>
        <p className="text-sm text-gray-500 mb-6">Sign in to continue planning your trips</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="animate-[fadeUp_0.45s_ease_both] [animation-delay:0.25s]">
            ...
            <div className="flex justify-end mt-1.5">
              <Link href="/auth/forgot-password" className="text-xs font-semibold text-violet-600 hover:underline">
                Forgot password?
              </Link>
            </div>
          </div>
          ...
          <button
            type="button"
            className="animate-[fadeUp_0.45s_ease_both] [animation-delay:0.44s] w-full flex items-center justify-center gap-2.5 py-2.5 bg-white border border-violet-200/60 rounded-xl text-sm font-semibold text-gray-700 hover:bg-violet-50 hover:shadow-md transition-all duration-200"
          >
            <GoogleIcon />
        ...
        <p className="text-center text-[13px] text-gray-500 mt-5">
          ...
          <Link href="/auth/signup" className="text-violet-600 font-bold hover:underline">
            Sign up
          </Link>
        </p>
      </div>
